...
namespace it.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<UserModel> signInManager, ILogger<LoginModel> logger, ItContext context, UserManager<UserModel> UserMgr, IHttpContextAccessor httpContextAccessor, IConfiguration configuration, LoginMailPyme LoginMailPyme)
        {
