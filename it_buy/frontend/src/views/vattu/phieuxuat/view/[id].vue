                        ...
                        <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-lg-12 pt-1">
                                        <KhoTreeSelect v-model="model.noidi" :multiple="false" :only_access="true"
                                            @update:modelValue="changeNoidi" :disabled="true">
                                        </KhoTreeSelect>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-lg-12 pt-1">
                                        <KhoTreeSelect v-model="model.noiden" :multiple="false" :disabled="true">
                                        </KhoTreeSelect>
                                    </div>
                                </div>
                            </div>
...
import FormNhan from "../../../../components/vattu/phieuxuat/FormNhan.vue";
