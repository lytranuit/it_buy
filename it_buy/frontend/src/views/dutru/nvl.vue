<template>
  <div class="row clearfix">
    <div class="col-12 mb-3">
      <Breadcrumb :home="{ icon: 'pi pi-home' }" :model="[{ label: 'Dự trù' }, { label: 'Nguyên vật liệu' },]">
      </Breadcrumb>
    </div>
    <div class="col-12">
        ...
        formatDate(slotProps.data.created_at, "YYYY-MM-DD HH:mm") }}</small>
                ...
                <template v-else-if="col.data == 'status_id'">
                  <div class="text-center">
                    <Tag value="Hoàn thành" severity="success" size="small"
                      v-if="slotProps.data['date_finish']" />
                    <Tag value="Nháp" severity="secondary" size="small"
                    ...
                    <Tag value="Đã duyệt" severity="success" size="small"
                      v-else-if="slotProps.data[col.data] == 4" />
                    <Tag value="Không duyệt" severity="danger" size="small"
