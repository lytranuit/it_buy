            ...
            <TabPanel>
              ...
              <Stepper orientation="vertical" :activeStep="activeStep">
                ...
                <StepperPanel
                  ...
                  v-if="model.is_multiple_ncc && model.status_id == 10"
                >
                  <template #content="{ prevCallback, nextCallback }">
...
import Danhsachdonhang from "../../../components/muahang/Danhsachdonhang.vue";
...
const { model, waiting, tabviewActive, user_created_by } =
  storeToRefs(storeMuahang);
