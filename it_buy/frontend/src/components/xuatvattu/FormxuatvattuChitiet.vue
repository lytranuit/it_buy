        ...
        <template #body="slotProps">
          <template v-if="col.data == 'tenhh' && model.status_id == 1">
            <div class="d-flex align-items-center">
              <vattu-auto-complete v-model="slotProps.data[col.data]" :disabled="slotProps.data['mahh'] != null"
...
import VattuAutoComplete from "../AutoComplete/VattuAutoComplete.vue";
...
const store_xuatvattu = usexuatvattu();
...
const { datatable, model, list_delete } = storeToRefs(store_xuatvattu);
