<template>
    ...
    <Dialog v-model:visible="visibleDialog" :header="headerForm" :modal="true" class="p-fluid">
        <div class="row mb-2">
            <div class="field col">
                <label for="name">Mã nhà cung cấp<span class="text-danger">*</span></label>
            ...
            <div class="field col">
                ...
                <InputText id="name" class="p-inputtext-sm" v-model.trim="model.tenncc" required="true"
                    :class="{ 'p-invalid': submitted && !model.tenncc }" />
                <small class="p-error" v-if="submitted && !model.tenncc">Required.</small>
            </div>
        </div>
        <div class="row mb-2">
            <div class="field col">
                <label for="name">Địa chỉ</label>
                <InputText id="name" class="p-inputtext-sm" v-model.trim="model.diachincc" />
            </div>
        </div>
        <div class="row mb-2">
            <div class="field col">
                <label for="name">Email</label>
                <InputText id="name" class="p-inputtext-sm" v-model.trim="model.emailncc" />
            </div>
            <div class="field col">
                <label for="name">Điện thoại</label>
                <InputText id="name" class="p-inputtext-sm" v-model.trim="model.dienthoaincc" />
            </div>
            <div class="field col">
                <label for="name">Tài khoản ngân hàng</label>
                <InputText id="name" class="p-inputtext-sm" v-model.trim="model.taikhoannh" />
            </div>
            <div class="field col">
                <label for="name">Mã số thuế</label>
                <InputText id="name" class="p-inputtext-sm" v-model.trim="model.masothue" />
            </div>
        </div>
        <div class="row mb-2">
        ...
        <div class="row mb-2">
            <div class="field col">
                ...
                <InputText id="name" class="p-inputtext-sm" v-model.trim="model.nguoilienhe" />
            </div>
            <div class="field col">
                <label for="name">Chức vụ</label>
                <InputText id="name" class="p-inputtext-sm" v-model.trim="model.chucvu" />
            </div>
            <div class="field col">
                <label for="name">Email</label>
                <InputText id="name" class="p-inputtext-sm" v-model.trim="model.email" />
            </div>
            <div class="field col">
                <label for="name">Điện thoại</label>
                <InputText id="name" class="p-inputtext-sm" v-model.trim="model.dienthoai" />
            </div>
        </div>
        <template #footer>
...
const valid = () => {
    ...
    if (!model.value.tenncc.trim()) return false;
    return true;
};
</script>