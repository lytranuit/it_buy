    ...
    <DataTable class="p-datatable-customers" showGridlines :value="datatable" :lazy="true" ref="dt" scrollHeight="70vh"
        ...
        <Column v-for="col of selectedColumns" :field="col.data" :header="col.label" :key="col.data"
            ...
            <template #body="slotProps">
                <template v-if="col.data == 'sohd'">
                    <RouterLink :to="'/vattu/phieunhap/edit/' + slotProps.data.hoadon.id">
                ...
                <template v-else-if="col.data == 'makho'">
...
const showing = ref([]);
const column_cache = "columns_phieunhap_chitiet";
const first = ref(0);
const rows = ref(10);
const draw = ref(0);
...
const loadLazyData = () => {
    loading.value = true;
    VattuApi.tableNhapChitiet(lazyParams.value).then((res) => {
